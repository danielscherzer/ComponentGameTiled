...
internal class Scene
{
	...
	private readonly HashSet<GameObject> gameObjects = []; //fast add and removal
	private readonly List<GameObject> removeGameObjects = [];
	private readonly List<GameObject> spawnedGameObjects = [];
